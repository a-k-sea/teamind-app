...
personality5 = Personality.create(abbreviation: 'INFJ', description: 'INFJs are creative solvers of people problems, and bring innovative ideas for fostering human potential. They are usually perceptive in observing the talents of others, and good at encouraging teammates to contribute their skills. They are mindful of group process, listening attentively to the opinions of others and synthesizing varied priorities to create a unified vision. Because they prefer to accommodate all points of view, Counselors may have trouble on very competitive or conflictual teams.
...
personality13 = Personality.create(abbreviation: 'ISTP', description: 'ISTPs are practical, task-oriented team members who are usually more focused on the problem at hand than the people involved. They tend to look for ways to contribute with immediate action, and are talented, straightforward troubleshooters. ISTPs rarely demand attention from the team, preferring instead to observe and jump in where they see an opportunity to get something done.
