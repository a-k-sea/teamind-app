...
personality11 = Personality.create(abbreviation: 'ESTJ', description: 'Extraverted, Observant, Thinking, and Judging. ESTJs are take-charge types who bring order and industrious energy to a team, focusing on opportunities to implement structure and take decisive action. ESTJs don’t mince words, sharing their objective evaluation of the situation directly and honestly. They are hard workers, productive and oriented to results, and expect others to fall in step with their methodic determination.
...
personality13 = Personality.create(abbreviation: 'ISTP', description: 'Introverted, Observant, Thinking, and Prospecting. ISTPs are practical, task-oriented team members who are usually more focused on the problem at hand than the people involved. They tend to look for ways to contribute with immediate action, and are talented, straightforward troubleshooters. ISTPs rarely demand attention from the team, preferring instead to observe and jump in where they see an opportunity to get something done.
