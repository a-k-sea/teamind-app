...
personality13 = Personality.create(abbreviation: 'ISTP', description: 'Introverted, Observant, Thinking, and Perceiving. ISTPs are practical, task-oriented team members who are usually more focused on the problem at hand than the people involved. They tend to look for ways to contribute with immediate action, and are talented, straightforward troubleshooters. ISTPs rarely demand attention from the team, preferring instead to observe and jump in where they see an opportunity to get something done.
